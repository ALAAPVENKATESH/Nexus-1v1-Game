...
**Nexus** is a fast-paced, arcade-style 2D spaceship combat game built using Python and Pygame. Engage in thrilling 1v1 battles against a smart AI bot or another player in a galactic arena.
